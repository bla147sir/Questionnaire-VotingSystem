...
function save_result(obj,tbox) {
	...
	location.href="v_d_candidate.php?value="+obj+'&list_text=' + str;
    }
...
function change(obj,tbox){
	...
	location.href="v_d_candidate.php?depart="+obj+'&list_text=' + str;
...
{
$sql_check="select * from CANDIDATE where ID='$id'";
...
$_SESSION["count_candidate"]=$_SESSION["count_candidate"]+1;
}
